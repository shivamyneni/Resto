...
const QueryThree = () => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .get(
        `/restaurants/query3/${formData.name}/${formData.rating}/${formData.cuisine}`
      )
      .then((res) => {
      ...
      <div className="w-1/3 p-[50px] flex flex-col mx-auto">
        <div className="mb-4 w-full ">
          <h2 className="text-md text-start mb-[13px] mt-[25px] font-bold font-Pathway">
            Find all favourite restaurants rated by a particular user with a
            rating greater than a particular value:
          </h2>
          <h2 className="text-md text-start mb-[13px] mt-[25px] font-bold font-Pathway">
            Username:
          </h2>
